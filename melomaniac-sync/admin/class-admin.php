		...
		wp_localize_script(
			...
			array(
				...
				'i18n'    => array(
					...
					'genericError'    => __( 'Algo falló. Intentá de nuevo.', 'melomaniac-sync' ),
					'emptyBarcode'    => __( 'Ingresá o escaneá un código de barra.', 'melomaniac-sync' ),
					'editProduct'     => __( 'Editar el producto', 'melomaniac-sync' ),
					'cameraUnsupported' => __( 'Este navegador no puede escanear con la cámara. Usá Chrome o Edge, o un lector USB.', 'melomaniac-sync' ),
					'cameraDenied'    => __( 'No se pudo acceder a la cámara. Revisá los permisos del navegador.', 'melomaniac-sync' ),
